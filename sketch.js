...
mainCyclist.setCollider("rectangle",mainCyclist.x,mainCyclist.y,
  mainCyclist.width-400,mainCyclist.height-450)
...
function draw() {
  ...
  text("Press Up Arrow to Restart the game!",100,270);
